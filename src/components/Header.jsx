      ...
      <div className="fixed top-0 left-0 right-0 z-10 bg-white shadow-md px-4 md:px-36 py-4 ">
        <div className="container mx-auto flex flex-col md:flex-row md:items-center">
          ...
          <div className="md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0">
            ...
            <Link to="/cart" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:text-orange-500 transition-colors duration-300"><FontAwesomeIcon icon={faShoppingBag} className="mr-4" />Cart <span className="font-extrabold text-green-400">{cartItems.length}</span> </Link>
          </div>
        </div>
      </div>
    </>
